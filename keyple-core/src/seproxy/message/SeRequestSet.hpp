...
#ifndef KEYPLE_SEPROXY_SEREQUEST_SET_H
#define KEYPLE_SEPROXY_SEREQUEST_SET_H
    ...
    namespace seproxy {
        namespace message {
            ...
            public:
                ...
                //     */
                //  private
                //    final Set<SeRequest> sortedRequests;
                //
                /**
                ...
                //     */
                //  public
                //    SeRequestSet(SeRequest request)
                //    {
            ...
            private:
                /**
                 * List of requests. Each {@link SeRequest} will result in a {@link SeResponse} wrapped
                 * in a {@link SeResponseSet}.
                 */
                std::unordered_set<SeRequest> sortedRequests;
            };
        } // namespace message
    } // namespace seproxy
} // namespace keyple

#endif // KEYPLE_SEPROXY_SEREQUEST_SET_H
