...
const std::shared_ptr<org::slf4j::Logger> AbstractObservableReaderTest::logger = org::slf4j::LoggerFactory::getLogger(AbstractObservableReaderTest::typeid);
...
//ORIGINAL LINE: @Test public void testAddRemoveObserver()
                    ...
                    std::shared_ptr<AbstractObservableReader> AbstractObservableReaderTest::getBlankAbstractObservableReader(const std::string &pluginName, const std::string &readerName) {

                        return std::make_shared<AbstractLocalReaderAnonymousInnerClass>(shared_from_this(), pluginName, readerName);
                    }

                    AbstractObservableReaderTest::AbstractLocalReaderAnonymousInnerClass::AbstractLocalReaderAnonymousInnerClass(std::shared_ptr<AbstractObservableReaderTest> outerInstance, const std::string &pluginName, const std::string &readerName) : AbstractLocalReader(pluginName, readerName) {
                    ...
                    bool AbstractObservableReaderTest::AbstractLocalReaderAnonymousInnerClass::protocolFlagMatches(std::shared_ptr<SeProtocol> protocolFlag) throw(KeypleReaderException) {
                        return false;
                    }
                    ...
                    std::unordered_map<std::string, std::string> AbstractObservableReaderTest::AbstractLocalReaderAnonymousInnerClass::getParameters() {
                        return nullptr;
                    }

                    void AbstractObservableReaderTest::AbstractLocalReaderAnonymousInnerClass::setParameter(const std::string &key, const std::string &value) throw(std::invalid_argument, KeypleBaseException) {

                    }

                    std::shared_ptr<ObservableReader::ReaderObserver> AbstractObservableReaderTest::getObserver() {
                        return std::make_shared<ReaderObserverAnonymousInnerClass>(shared_from_this());
                    }

                    AbstractObservableReaderTest::ReaderObserverAnonymousInnerClass::ReaderObserverAnonymousInnerClass(std::shared_ptr<AbstractObservableReaderTest> outerInstance) {
                        this->outerInstance = outerInstance;
                    }

                    void AbstractObservableReaderTest::ReaderObserverAnonymousInnerClass::update(std::shared_ptr<ReaderEvent> readerEvent) {
                    }
                    ...
                    AbstractObservableReaderTest::AnswerAnonymousInnerClass::AnswerAnonymousInnerClass(std::shared_ptr<AbstractObservableReaderTest> outerInstance) {
                        this->outerInstance = outerInstance;
                    }

                    std::shared_ptr<void> AbstractObservableReaderTest::AnswerAnonymousInnerClass::answer(std::shared_ptr<InvocationOnMock> invocation) throw(std::runtime_error) {
                        outerInstance->startObservationCall->countDown();
                        return nullptr;
                    }

                    AbstractObservableReaderTest::AnswerAnonymousInnerClass2::AnswerAnonymousInnerClass2(std::shared_ptr<AbstractObservableReaderTest> outerInstance) {
                        this->outerInstance = outerInstance;
                    }

                    std::shared_ptr<void> AbstractObservableReaderTest::AnswerAnonymousInnerClass2::answer(std::shared_ptr<InvocationOnMock> invocation) throw(std::runtime_error) {
