        ...
        namespace keyple {
            namespace seproxy {
                namespace plugin {
                     ...
                     */
                    class AbstractObservablePlugin : public AbstractLoggedObservable<std::shared_ptr<PluginEvent>>, public ReaderPlugin {
                    ...
                    protected:
                         ...
                         */
                    public:
                        std::shared_ptr<SortedSet<std::shared_ptr<AbstractObservableReader>>> getReaders() throw(KeypleReaderException) override;
                         ...
                         */
                    protected:
                        virtual std::shared_ptr<SortedSet<std::shared_ptr<AbstractObservableReader>>> getNativeReaders() = 0;
