...
#include "../command/AbstractApduResponseParser.h"
        ...
        namespace keyple {
            namespace core {
                namespace selection {
                    ...
                    AbstractSeSelectionRequest::AbstractSeSelectionRequest(std::shared_ptr<SeSelector> seSelector, ChannelState channelState) : seSelector(seSelector), channelState(channelState) {
                    }
                    ...
                    std::shared_ptr<AbstractApduResponseParser> AbstractSeSelectionRequest::getCommandParser(std::shared_ptr<SeResponse> seResponse, int commandIndex) {
