...
public:
     ...
     */
    AbstractIso7816CommandBuilder(CommandsTable& commandReference, std::shared_ptr<ApduRequest> request);
...
protected:
     ...
     */
    virtual std::shared_ptr<ApduRequest> setApduRequest(char cla, CommandsTable& command, char p1, char p2, std::vector<char> &dataIn,
                                                        char le);
