        ...
        namespace keyple {
            namespace calypso {
                namespace transaction {
                    ...
                    SamSelector::SamSelector(SamRevision samRevision, const std::string &serialNumber, const std::string &extraInfo) : org::eclipse::keyple::core::seproxy::SeSelector(SeCommonProtocols::PROTOCOL_ISO7816_3, new AtrFilter(nullptr), nullptr, extraInfo) {
                            std::string atrRegex;
                            std::string snRegex;
