...
#include "../../../../../../../../../../../../keyple-core/src/main/java/org/eclipse/keyple/core/seproxy/message/ApduResponse.h"
...
const std::unordered_map<Integer, std::shared_ptr<StatusProperties>> CardGenerateKeyRespPars::STATUS_TABLE;

                                CardGenerateKeyRespPars::StaticConstructor::StaticConstructor() {
                                                                            std::unordered_map<Integer, std::shared_ptr<StatusProperties>> m(AbstractSamResponseParser::STATUS_TABLE);
...
CardGenerateKeyRespPars::StaticConstructor CardGenerateKeyRespPars::staticConstructor;
                                ...
                                std::unordered_map<Integer, std::shared_ptr<StatusProperties>> CardGenerateKeyRespPars::getStatusTable() {
                                    return STATUS_TABLE;
                                }
