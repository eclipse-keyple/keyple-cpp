                    ...
                    namespace po {
                        namespace builder {
                            namespace session {
                                ...
                                class OpenSession24CmdBuild final : public AbstractOpenSessionCmdBuild {
                                    /**
                                     ...
                                     */
                                public:
                                    OpenSession24CmdBuild(char keyIndex, std::vector<char> &samChallenge, char sfiToSelect, char recordNumberToRead, const std::string &extraInfo) throw(std::invalid_argument);

protected:
                                    std::shared_ptr<OpenSession24CmdBuild> shared_from_this() {
                                        return std::static_pointer_cast<OpenSession24CmdBuild>(AbstractOpenSessionCmdBuild::shared_from_this());
                                    }
                                };
