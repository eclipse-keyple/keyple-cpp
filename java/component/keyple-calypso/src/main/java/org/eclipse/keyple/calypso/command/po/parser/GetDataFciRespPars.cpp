...
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_FCI_TEMPLATE = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x0F, org::eclipse::keyple::core::util::bertlv::Tag::APPLICATION, CONSTRUCTED);
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_DF_NAME = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x04, org::eclipse::keyple::core::util::bertlv::Tag::CONTEXT, PRIMITIVE);
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_FCI_PROPRIETARY_TEMPLATE = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x05, org::eclipse::keyple::core::util::bertlv::Tag::CONTEXT, CONSTRUCTED);
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_FCI_ISSUER_DISCRETIONARY_DATA = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x0C, org::eclipse::keyple::core::util::bertlv::Tag::CONTEXT, CONSTRUCTED);
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_APPLICATION_SERIAL_NUMBER = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x07, org::eclipse::keyple::core::util::bertlv::Tag::PRIVATE, PRIMITIVE);
const std::shared_ptr<org::eclipse::keyple::core::util::bertlv::Tag> GetDataFciRespPars::TAG_DISCRETIONARY_DATA = std::make_shared<org::eclipse::keyple::core::util::bertlv::Tag>(0x13, org::eclipse::keyple::core::util::bertlv::Tag::APPLICATION, PRIMITIVE);
...
GetDataFciRespPars::GetDataFciRespPars(std::shared_ptr<ApduResponse> selectApplicationResponse) : org::eclipse::keyple::calypso::command::po::AbstractPoResponseParser(selectApplicationResponse) {
    ...
    try {
        ...
        tlv = std::make_shared<TLV>(response);
        ...
        if (logger->isDebugEnabled()) {
            logger->debug("Application Serial Number = %s", ByteArrayUtils::toHex(applicationSN));
        }
