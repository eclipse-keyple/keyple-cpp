                        ...
                        namespace builder {
                            namespace session {
                                ...
                                class OpenSession31CmdBuild final : public AbstractOpenSessionCmdBuild {
                                     ...
                                     */
                                public:
                                    OpenSession31CmdBuild(char keyIndex, std::vector<char> &samChallenge, char sfiToSelect, char recordNumberToRead, const std::string &extraInfo) throw(std::invalid_argument);
