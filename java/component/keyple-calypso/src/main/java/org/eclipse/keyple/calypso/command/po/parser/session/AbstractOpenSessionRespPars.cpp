...
const std::unordered_map<Integer, std::shared_ptr<StatusProperties>> AbstractOpenSessionRespPars::STATUS_TABLE;
...
AbstractOpenSessionRespPars::StaticConstructor AbstractOpenSessionRespPars::staticConstructor;
                                ...
                                std::unordered_map<Integer, std::shared_ptr<AbstractApduResponseParser::StatusProperties>> AbstractOpenSessionRespPars::getStatusTable() {
                                    // At this stage, the status table is the same for everyone
                                    return STATUS_TABLE;
                                }

                                AbstractOpenSessionRespPars::AbstractOpenSessionRespPars(std::shared_ptr<ApduResponse> response, PoRevision revision) : org::eclipse::keyple::command::AbstractApduResponseParser(response), revision(revision) {
                                ...
                                std::shared_ptr<AbstractOpenSessionRespPars> AbstractOpenSessionRespPars::create(std::shared_ptr<ApduResponse> response, PoRevision revision) {
                                    switch (revision) {
                                        ...
                                        default:
                                            throw std::invalid_argument("Unknow revision " + revision);
                                    }
                                }
                                ...
                                int AbstractOpenSessionRespPars::getTransactionCounterValue() {
                                    return ByteBuffer::wrap(secureSession->getChallengeTransactionCounter()).order(java::nio::ByteOrder::LITTLE_ENDIAN).getInt();
                                }
