                    ...
                    namespace sam {
                        namespace builder {
                            namespace session {
                                ...
                                DigestAuthenticateCmdBuild::DigestAuthenticateCmdBuild(SamRevision revision, std::vector<char> &signature) throw(std::invalid_argument) : org::eclipse::keyple::calypso::command::sam::SamCommandBuilder(command, nullptr) {
                                    if (revision != nullptr) {
                                    ...
                                    request = setApduRequest(cla, command, p1, p2, signature, nullptr);
                                }
                            }
                        }
                    }
