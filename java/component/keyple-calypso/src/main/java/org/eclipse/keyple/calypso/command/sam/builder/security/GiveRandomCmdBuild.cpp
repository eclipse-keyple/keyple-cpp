                    ...
                    namespace sam {
                        namespace builder {
                            namespace security {
                                ...
                                GiveRandomCmdBuild::GiveRandomCmdBuild(SamRevision revision, std::vector<char> &random) : org::eclipse::keyple::calypso::command::sam::AbstractSamCommandBuilder(command, nullptr) {
                                    if (revision != nullptr) {
                                    ...
                                    request = setApduRequest(cla, command, p1, p2, random, nullptr);
                                }
                            }
                        }
                    }
