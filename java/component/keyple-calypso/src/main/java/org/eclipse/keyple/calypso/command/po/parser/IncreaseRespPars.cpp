...
const std::unordered_map<Integer, std::shared_ptr<StatusProperties>> IncreaseRespPars::STATUS_TABLE;
...
IncreaseRespPars::StaticConstructor IncreaseRespPars::staticConstructor;
                            ...
                            std::unordered_map<Integer, std::shared_ptr<AbstractApduResponseParser::StatusProperties>> IncreaseRespPars::getStatusTable() {
                                return STATUS_TABLE;
                            }
                            ...
                            int IncreaseRespPars::getNewValue() throw(IllegalStateException) {
                            ...
                            std::string IncreaseRespPars::toString() {
                                return std::string::format("New counter value: %d", getNewValue());
                            }
                        }
                    }
                }
