...
#include "../../../../../../../main/java/org/eclipse/keyple/calypso/transaction/PoSelector.h"
            ...
            namespace calypso {
                namespace transaction {
                    ...
                    std::shared_ptr<CalypsoPo> CalypsoPoTest::getPoApplicationByte(char applicationByte) {
                        ...
                        std::shared_ptr<PoSelector> poSelector = std::make_shared<PoSelector>(ByteArrayUtils::fromHex("315449432E494341"), SeSelector::SelectMode::FIRST, ChannelState::KEEP_OPEN, ContactlessProtocols::PROTOCOL_ISO14443_4, nullptr);
                        std::shared_ptr<CalypsoPo> calypsoPo = std::make_shared<CalypsoPo>(poSelector);
