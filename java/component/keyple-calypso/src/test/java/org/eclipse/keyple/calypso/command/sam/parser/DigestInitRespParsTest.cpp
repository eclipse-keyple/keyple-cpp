...
#include "../../../../../../../../../main/java/org/eclipse/keyple/calypso/command/sam/parser/session/DigestInitRespPars.h"
        ...
        namespace keyple {
            namespace calypso {
                namespace command {
                    namespace sam {
                        namespace parser {
                            using DigestInitRespPars = org::eclipse::keyple::calypso::command::sam::parser::session::DigestInitRespPars;
...
//ORIGINAL LINE: @Test public void digestInitRespPars()
                            void DigestInitRespParsTest::digestInitRespPars() {
                                ...
                                Assert::assertArrayEquals(std::vector<char> {static_cast<char>(0x90), 0x00}, apduResponseParser->getApduResponse()->getBytes());
                            }
                        }
                    }
                }
