                ...
                namespace remotese {
                    namespace nativese {
                        namespace method {
                            ...
                            class RmTransmitExecutor : public std::enable_shared_from_this<RmTransmitExecutor>, public RemoteMethodExecutor {
                            ...
                            public:
                                RmTransmitExecutor(std::shared_ptr<NativeReaderServiceImpl> nativeReaderService);
