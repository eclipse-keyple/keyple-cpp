            ...
            namespace example {
                namespace calypso {
                    namespace pc {
                         ...
                         * </ul>
                         */
                        class UseCase_Calypso4_PoAuthentication_Stub : public std::enable_shared_from_this<UseCase_Calypso4_PoAuthentication_Stub> {
                        private:
                            static const std::shared_ptr<Logger> logger;

                            static void main(std::vector<std::string> &args) throw(KeypleBaseException, NoStackTraceThrowable, InterruptedException);
                        };
