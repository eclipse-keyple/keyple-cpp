#include "UseCase_Calypso1_ExplicitSelectionAid_Pcsc.h"
...
const std::shared_ptr<org::slf4j::Logger> UseCase_Calypso1_ExplicitSelectionAid_Pcsc::logger = org::slf4j::LoggerFactory::getLogger(UseCase_Calypso1_ExplicitSelectionAid_Pcsc::typeid);

                        void UseCase_Calypso1_ExplicitSelectionAid_Pcsc::main(std::vector<std::string> &args) throw(KeypleBaseException, InterruptedException, IOException, NoStackTraceThrowable) {
