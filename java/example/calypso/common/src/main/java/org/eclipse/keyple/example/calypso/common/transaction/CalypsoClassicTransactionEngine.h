...
public:
     ...
     */
    virtual void doCalypsoReadWriteTransaction(std::shared_ptr<PoTransaction> poTransaction, bool closeSeChannel);

    /**
     *
     */
    virtual std::shared_ptr<AbstractDefaultSelectionsRequest> preparePoSelection();
...
protected:
    ...
    {
        return std::static_pointer_cast<CalypsoClassicTransactionEngine>(AbstractReaderObserverEngine::shared_from_this());
    }
};
