...
{
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_ISO14443_4,
                                  "3B8880....................|3B8B80.*|"
                                  "3B8C800150.*|.*4F4D4141544C4153.*");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_B_PRIME,
                                  "3B8F8001805A0...................829000..");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_MIFARE_UL,
                                  "3B8F8001804F0CA0000003060300030000000068");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_MIFARE_CLASSIC,
                                  "3B8F8001804F0CA000000306030001000000006A");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_MIFARE_DESFIRE,
                                  "3B8180018080");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_MEMORY_ST25,
                                  "3B8F8001804F0CA000000306070007D0020C00B6");
    PCSC_PROTOCOL_SETTING.emplace(SeCommonProtocols::PROTOCOL_ISO7816_3, "3.*");
}
