            ...
            namespace plugin {
                namespace remotese {
                    namespace pluginse {
                        ...
                        class RmConnectReaderExecutor : public std::enable_shared_from_this<RmConnectReaderExecutor>, public RemoteMethodExecutor {
                        ...
                        public:
                            RmConnectReaderExecutor(std::shared_ptr<RemoteSePlugin> plugin, std::shared_ptr<DtoSender> dtoSender);
