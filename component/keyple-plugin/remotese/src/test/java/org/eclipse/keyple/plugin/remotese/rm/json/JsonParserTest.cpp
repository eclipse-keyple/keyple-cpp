...
//ORIGINAL LINE: @Test public void testSelectionByAidRequest()
                            void JsonParserTest::testSelectionByAidRequest() {
                                std::shared_ptr<DefaultSelectionRequest> defaultSelectionRequest = SampleFactory::getSelectionRequest();
                                testSerializeDeserializeObj(defaultSelectionRequest, DefaultSelectionRequest::typeid);
                            }

//JAVA TO C++ CONVERTER TODO TASK: Most Java annotations will not have direct C++ equivalents:
//ORIGINAL LINE: @Test public void testSelectionByAtrRequest()
                            void JsonParserTest::testSelectionByAtrRequest() {
                                std::shared_ptr<DefaultSelectionRequest> defaultSelectionRequest = SampleFactory::getSelectionRequest();
                                testSerializeDeserializeObj(defaultSelectionRequest, DefaultSelectionRequest::typeid);
                            }
