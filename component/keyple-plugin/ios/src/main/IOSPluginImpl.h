...
class KEYPLEPLUGINIOS_API IOSPluginImpl
: public virtual AbstractThreadedObservablePlugin, public virtual IOSPlugin {
public:
    /**
     *
     */
    ...
    /**
     * Gets the single instance of IOSPlugin.
     *
     * @return single instance of IOSPlugin
     * @throw KeypleReaderException if a reader error occurs
     */
    static std::shared_ptr<IOSPluginImpl> getInstance();
...
private:
    ...
    const std::shared_ptr<Logger> logger =
        LoggerFactory::getLogger(typeid(IOSPlugin));

    /**
     * Singleton instance of SeProxyService
     */
    static std::shared_ptr<IOSPluginImpl> mInstance;

    /**
     *
     */
    std::vector<IOSTerminal> mTerminals;

    /**
     *
     */
    std::vector<IOSTerminal>& getTerminals();
