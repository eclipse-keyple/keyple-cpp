...
class KEYPLEPLUGINIOS_API IOSReaderImpl
: public virtual AbstractObservableLocalReader, public virtual IOSReader,
  public SmartInsertionReader, public SmartRemovalReader {
public:
    /**
     * This constructor should only be called by IOSPlugin IOS reader
     ...
     */
    IOSReaderImpl(const std::string& pluginName, const IOSTerminal& terminal);
...
private:
    ...
    const std::shared_ptr<Logger> mLogger =
        LoggerFactory::getLogger(typeid(IOSReaderImpl));
