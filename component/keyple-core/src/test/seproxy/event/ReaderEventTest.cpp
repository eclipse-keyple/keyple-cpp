...
//ORIGINAL LINE: @Test public void testReaderEvent()
                    void ReaderEventTest::testReaderEvent() {
                        std::shared_ptr<ReaderEvent> event_Renamed = std::make_shared<ReaderEvent>("plugin", "reader", ReaderEvent::EventType::IO_ERROR, nullptr);
...
//ORIGINAL LINE: @Test public void testGetEvent()
                    void ReaderEventTest::testGetEvent() {
                        ...
                        assertEquals(event_Renamed->getEventType(), ReaderEvent::EventType::IO_ERROR);
                    }
                }
            }
        }
