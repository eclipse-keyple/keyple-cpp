...
AbstractSelectionLocalReader::AbstractSelectionLocalReader(
    ...
    std::shared_ptr<SeSelector::AidSelector> aidSelector)
{
    ...
    selectApplicationCommand[3] =
        static_cast<char>(aidSelector->getFileOccurrence().getIsoBitMask() |
                          aidSelector->getFileControlInformation()
                              .getIsoBitMask());
