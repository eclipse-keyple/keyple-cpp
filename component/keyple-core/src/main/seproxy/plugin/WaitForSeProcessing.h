 ...
 * </ul>
 */
class KEYPLECORE_API WaitForSeProcessing final : public AbstractObservableState {
public:
    /**
     *
     */
...
private:
     ...
     * Logger
     */
    const std::shared_ptr<Logger> mLogger = LoggerFactory::getLogger(typeid(WaitForSeProcessing));
};
