...
private:
     ...
     */
    std::vector<std::shared_ptr<AbstractSeSelectionRequest>> seSelectionRequestList =
        std::vector<std::shared_ptr<AbstractSeSelectionRequest>>();

    /**
     *
     */
    const std::shared_ptr<SeRequestSet> selectionRequestSet =
        std::make_shared<SeRequestSet>(std::make_shared<std::set<std::shared_ptr<SeRequest>>>());
