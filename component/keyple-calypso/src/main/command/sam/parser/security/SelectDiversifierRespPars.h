/******************************************************************************
 * Copyright (c) 202° Calypso Networks Association                            *
 ...
 */
class KEYPLECALYPSO_API SelectDiversifierRespPars final
...
public:
     ...
     */
    SelectDiversifierRespPars(const std::shared_ptr<ApduResponse> response,
