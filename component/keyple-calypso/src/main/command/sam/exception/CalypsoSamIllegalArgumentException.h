...
/**
 * The exception {@code CalypsoSamIllegalArgumentException} indicates that the
 * input user data do not allow to build a syntactically correct command.
 */
class CalypsoSamIllegalArgumentException final
