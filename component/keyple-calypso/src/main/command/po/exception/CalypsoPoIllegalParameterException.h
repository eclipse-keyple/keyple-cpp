...
/**
 * The exception {@code CalypsoPoIllegalParameterException} indicates that some
 * input parameter is not accepted by the PO.
 */
class CalypsoPoIllegalParameterException final
