...
/**
 * The exception {@code CalypsoPoSessionBufferOverflowException} indicates
 * during a secure session that the PO session buffer will overflow.
 */
class CalypsoPoSessionBufferOverflowException final
