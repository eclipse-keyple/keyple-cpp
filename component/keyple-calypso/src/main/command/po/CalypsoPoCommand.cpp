...
const CalypsoPoCommand CalypsoPoCommand::GET_DATA_FCI("Get Data'FCI'", 0xCA);
const CalypsoPoCommand CalypsoPoCommand::OPEN_SESSION_10("Open Secure Session V1", 0x8A);
const CalypsoPoCommand CalypsoPoCommand::OPEN_SESSION_24("Open Secure Session V2.4", 0x8A);
const CalypsoPoCommand CalypsoPoCommand::OPEN_SESSION_31("Open Secure Session V3.1", 0x8A);
const CalypsoPoCommand CalypsoPoCommand::OPEN_SESSION_32("Open Secure Session V3.2", 0x8A);
const CalypsoPoCommand CalypsoPoCommand::CLOSE_SESSION("Close Secure Session", 0x8E);
const CalypsoPoCommand CalypsoPoCommand::READ_RECORDS("Read Records", 0xB2);
const CalypsoPoCommand CalypsoPoCommand::UPDATE_RECORD("Update Record", 0xDC);
const CalypsoPoCommand CalypsoPoCommand::WRITE_RECORD("Write Record", 0xD2);
const CalypsoPoCommand CalypsoPoCommand::APPEND_RECORD("Append Record", 0xE2);
const CalypsoPoCommand CalypsoPoCommand::GET_CHALLENGE("Get Challenge", 0x84);
const CalypsoPoCommand CalypsoPoCommand::INCREASE("Increase", 0x32);
...
{
    return mInstructionbyte == other.mInstructionbyte &&
           mName == other.mName;
}
