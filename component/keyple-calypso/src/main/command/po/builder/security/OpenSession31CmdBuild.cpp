...
OpenSession31CmdBuild::OpenSession31CmdBuild(const uint8_t keyIndex,
...
std::shared_ptr<AbstractOpenSessionRespPars> OpenSession31CmdBuild::createResponseParser(
