...
PoSelector::PoAidSelector::PoAidSelector(std::shared_ptr<IsoAid> aidToSelect, InvalidatedPo invalidatedPo, FileOccurrence fileOccurrence,
                                         FileControlInformation fileControlInformation)
: AidSelector(aidToSelect, invalidatedPo == InvalidatedPo::ACCEPT ? successfulSelectionStatusCodes : nullptr, fileOccurrence,
  fileControlInformation)
{
}

PoSelector::PoAidSelector::PoAidSelector(std::shared_ptr<IsoAid> aidToSelect, InvalidatedPo invalidatedPo)
: AidSelector(aidToSelect, invalidatedPo == InvalidatedPo::ACCEPT ? successfulSelectionStatusCodes : nullptr)
{
}
