...
{
    keySettings.insert(std::pair<DefaultKeyInfo, Byte>(
        DefaultKeyInfo::SAM_DEFAULT_KIF_PERSO, Byte(DEFAULT_KIF_PERSO)));
    keySettings.insert(std::pair<DefaultKeyInfo, Byte>(
        DefaultKeyInfo::SAM_DEFAULT_KIF_LOAD, Byte(DEFAULT_KIF_LOAD)));
    keySettings.insert(std::pair<DefaultKeyInfo, Byte>(
        DefaultKeyInfo::SAM_DEFAULT_KIF_DEBIT, Byte(DEFAULT_KIF_DEBIT)));
    keySettings.insert(std::pair<DefaultKeyInfo, Byte>(
        DefaultKeyInfo::SAM_DEFAULT_KEY_RECORD_NUMBER,
        Byte(DEFAULT_KEY_RECORD_NUMER)));
}
