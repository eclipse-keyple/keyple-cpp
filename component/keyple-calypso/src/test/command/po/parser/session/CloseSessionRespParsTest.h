...
//ORIGINAL LINE: @RunWith(MockitoJUnitRunner.class) public class CloseSessionRespParsTest
                                class CloseSessionRespParsTest : public std::enable_shared_from_this<CloseSessionRespParsTest> {
                                public:
//JAVA TO C++ CONVERTER TODO TASK: Most Java annotations will not have direct C++ equivalents:
