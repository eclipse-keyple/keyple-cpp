...
void OpenSessionCmdBuildTest::openSessionCmdBuild_rev_2_4()
{
    ...
    // revision 2.4
    char le                      = 0; // case 4
    std::vector<char> request2_4 = {cla,
                                    cmd,
                                    p1,
                                    p2,
                                    static_cast<char>(dataIn.size()),
...
void OpenSessionCmdBuildTest::openSessionCmdBuild_rev_3_1()
{
    ...
    // revision 3.1
    std::vector<char> request3_1 = {cla,
                                    cmd,
                                    p1,
                                    p2,
                                    static_cast<char>(dataIn.size()),
...
void OpenSessionCmdBuildTest::openSessionCmdBuild_rev_3_2()
{
    ...
    char le = 0; // case 4
    // revision 3.2
    std::vector<char> request3_2 = {cla,
                                    cmd,
                                    p1,
                                    p2,
                                    static_cast<char>(samChallenge.size() + 1),
