                    ...
                    namespace po {
                        namespace builder {
                            ...
                            void UpdateRecordCmdBuildTest::updateRecordCmdBuild_rev2_4() {
                                ...
                                apduCommandBuilder = std::make_shared<UpdateRecordCmdBuild>(keyple::calypso::command::PoClass::LEGACY, static_cast<char>(0x08), record_number, newRecordData, "TestRev2_4");
                            ...
                            void UpdateRecordCmdBuildTest::updateRecordCmdBuild_rev3_1() {
                                ...
                                apduCommandBuilder = std::make_shared<UpdateRecordCmdBuild>(keyple::calypso::command::PoClass::ISO, static_cast<char>(0x08), record_number, newRecordData, "TestRev3_1");
                                apduRequest = apduCommandBuilder->getApduRequest();
                            ...
                            void UpdateRecordCmdBuildTest::updateRecordCmdBuild_rev3_2() {
                                ...
                                apduCommandBuilder = std::make_shared<UpdateRecordCmdBuild>(keyple::calypso::command::PoClass::ISO, static_cast<char>(0x08), record_number, newRecordData, "TestRev3_2");
                                apduRequest = apduCommandBuilder->getApduRequest();
...
{
    std::shared_ptr<UpdateRecordCmdBuildTest> LocalTest = std::make_shared<UpdateRecordCmdBuildTest>();
