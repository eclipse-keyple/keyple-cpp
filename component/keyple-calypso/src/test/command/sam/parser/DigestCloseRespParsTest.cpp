...
void DigestCloseRespParsTest::digestCloseRespPars()
{
    ...
    std::vector<char> cResp0 = std::vector<char>{static_cast<char>(0xA8), 0x31,
                                                 static_cast<char>(0xC3), 0x3E,
    ...
    std::vector<char> cResp = std::vector<char>{static_cast<char>(0xA8), 0x31,
                                                static_cast<char>(0xC3), 0x3E,
                                                static_cast<char>(0x90), 0x00};
