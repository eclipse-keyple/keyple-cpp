 ...
 */
class CalypsoClassicTransactionEngine final : public AbstractReaderObserverEngine {
public:
    /**
     * Constructor
     */
     ...
     */
    void setReaders(std::shared_ptr<SeReader> poReader, std::shared_ptr<SeReader> samReader);
     ...
     *        errors)
     * @throw CalypsoPoCommandException if a PO command failed
     * @throw CalypsoSamCommandException if a SAM command failed
     */
    void doCalypsoReadWriteTransaction(std::shared_ptr<CalypsoPo> calypsoPo,
     ...
     */
    void processSeMatch(const std::shared_ptr<AbstractDefaultSelectionsResponse> selectionResponse)
        override;
...
private:
     ...
     *
     */
    std::shared_ptr<SeResource<CalypsoSam>> mSamResource = nullptr;

    /**
     *
     */
    std::shared_ptr<SeSelection> mSeSelection;

    /**
     *
     */
    bool mSamChannelOpen;
};
