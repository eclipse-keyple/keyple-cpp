...
const std::string StubSamCalypsoClassic::SE_PROTOCOL = "PROTOCOL_ISO7816_3";
...
StubSamCalypsoClassic::StubSamCalypsoClassic()
{
    ...
    addHexCommand("808A00FF27307E0308306C00307E1D24B928480800000606F000120000"
                  ...
                  "9000");
    /* Digest Init */
    addHexCommand("808A00FF273079030490980030791D01112233445566778899AABBCCDD" \
                  "EEFF00112233445566778899AABBCC",
                  "9000");
    /* Digest Update */
    ...
    addHexCommand("808C00007E011D00000FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF"
                  ...
                  "9000");
    /* Digest Update */
    addHexCommand("808C00002200E200401D01112233445566778899AABBCCDDEEFF00112233445566778899AABBCC",
                  "9000");
    /* Digest Close */
