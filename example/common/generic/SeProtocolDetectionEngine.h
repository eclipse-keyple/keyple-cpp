 ...
 */
class SeProtocolDetectionEngine final : public AbstractReaderObserverEngine {
public:
    /**
     *
     */
     ...
     */
    void setReader(std::shared_ptr<SeReader> poReader);

    /**
     *
     */
    std::shared_ptr<AbstractDefaultSelectionsRequest> prepareSeSelection();
