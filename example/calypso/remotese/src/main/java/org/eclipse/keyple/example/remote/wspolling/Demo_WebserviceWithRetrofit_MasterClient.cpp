#include "Demo_WebserviceWithRetrofit_MasterClient.h"
            ...
            namespace example {
                namespace remote {
                    namespace wspolling {
                        ...
                        void Demo_WebserviceWithRetrofit_MasterClient::main(std::vector<std::string> &args) throw(std::runtime_error) {
