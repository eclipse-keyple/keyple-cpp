...
Dedicated reader’s plugins have to be implemented in order to interface the SE Proxy API with the specific reader’s
drivers.

![global architecture](doc/images/sdk_global_architecture.png "keyple SDK global architecture")
